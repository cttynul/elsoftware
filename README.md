# el software ⚽
Vinci al Fantacalcio usando librerie di pandas a caso, facendo credere a tutti che tu viva nel futuro e stia facendo il fantacalcio utilizzando il machine learning.

## Disclaimer
Lasciando fare l'asta a questo software sono arrivato **PENULTIMO**, però ho scoperto Zaccagni negli anni d'oro a Verona. Il codice l'ho scritto tipo 5 anni fa, non mi scuso per eventuali abomini al suo interno.
Se sei allergico allo spaghetti code runna e basta.

Ci tengo a precisare che ha contribuito a rendere il codice ancora più orribile il mio afk friends **MC**, no non è un rapper scongelato direttamente dal 2010.
